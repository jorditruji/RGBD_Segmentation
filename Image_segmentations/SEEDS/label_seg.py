...
quanti=quantize(gray_image,24,qtype='uniform',displayLevels=256)
...
#MIRROR PADDING:
padded_data = cv2.copyMakeBorder(quanti,1,1,1,1,cv2.BORDER_REFLECT)
data = quanti
...
plt.imshow(labels*20, cmap='Greys')
